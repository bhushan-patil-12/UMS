<?php include('../../process/courses/edit-courses.php'); ?>
...
<div class="container">
        ...
        <form class="needs-validation" novalidate action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" placeholder="Course ID" id="id" required name="id"  disabled value="<?php echo $id; ?>">
                </div>
            </div>

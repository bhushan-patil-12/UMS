<?php include('../../process/project/edit-project.php'); ?>
...
<body>
    <div class="container">
        <h1 class="mt-3">Update Research Project Information:</h1>
        <form class="needs-validation" novalidate action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <div class="form-group row mt-3">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" placeholder="Project ID" id="id" required name="id" disabled value="<?php echo $row['project_id']; ?>"> 
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" placeholder="Project Name" id="name" required name="name" value="<?php echo $row['project_name']; ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" placeholder="Area" id="area" required name="area" value="<?php echo $row['project_area']; ?>">
                </div>
            </div>

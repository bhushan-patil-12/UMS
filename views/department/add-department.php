<?php include('../../process/department/add-department.php'); ?>
...
<body>
    <div class="container">
        <h1 class="mt-3">Department Registration:</h1>
        <form class="needs-validation mt-4" novalidate action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                ...
                <div class="col-sm-8">
                    <select class="custom-select" id="college" name="college">
                        ...
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($sql_dept)){
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" placeholder="Department ID" id="id" required name="id">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" placeholder="Department Name" id="name" required name="name">
                </div>
            </div>

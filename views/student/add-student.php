<?php include('../../process/student/add-student.php'); ?>
...
<body>
    <div class="container">
        <h1 class="mt-3">Student Registration:</h1>
        <form class="needs-validation" novalidate action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" name="id" placeholder="Student ID" id="id" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <select class="custom-select" id="gender" name="gender">
                        <option selected disabled="disabled">Select a option</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input class="form-control" type="date" placeholder="email" id="dob" name="dob">
                </div>
            </div>
